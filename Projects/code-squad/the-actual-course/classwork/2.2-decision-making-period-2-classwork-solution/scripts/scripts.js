...
const total = () => Number(((item1price + item2price + item3price) * 1.0625).toFixed(2));
...
function validTotal() {
    switch (true) {
        case (total() > 0):
            ...
            break;
    default:
            document.getElementById('total').innerHTML = "You entered one or more invalid prices. Refresh the page and try again."
            break;
    };
};
